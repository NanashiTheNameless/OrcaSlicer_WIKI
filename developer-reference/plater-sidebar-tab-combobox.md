...
## [`Plater`](https://github.com/NanashiTheNameless/OrcaSlicer/blob/main/src/slic3r/GUI/Plater.hpp)
...
## [`Sidebar`](https://github.com/NanashiTheNameless/OrcaSlicer/blob/main/src/slic3r/GUI/Plater.hpp)

This is relating the the sidebar in the application window

![full-sidebar](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/GUI/full-sidebar.png?raw=true)

## [`ComboBox`](https://github.com/NanashiTheNameless/OrcaSlicer/blob/main/src/slic3r/GUI/Widgets/ComboBox.hpp)
...
## [`Tab`](https://github.com/NanashiTheNameless/OrcaSlicer/blob/main/src/slic3r/GUI/Tab.hpp)
...
![tab-popup](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/GUI/tab-popup.png?raw=true)
