...
## [`Preset`](https://github.com/NanashiTheNameless/OrcaSlicer/blob/main/src/libslic3r/Preset.hpp)
...
![process-preset-full](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/GUI/process-preset-full.png?raw=true)
...
## [`PresetBundle`](https://github.com/NanashiTheNameless/OrcaSlicer/blob/main/src/libslic3r/PresetBundle.hpp)
...
## [`PresetCollection`](https://github.com/NanashiTheNameless/OrcaSlicer/blob/main/src/libslic3r/Preset.hpp)
