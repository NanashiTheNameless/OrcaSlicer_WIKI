...
If you need a guide for how to download PR versions you **SHOULD NOT BE USING THEM**! \
THIS FORK IS FOR ADVANCED USERS. **IF YOU DONT KNOW EXACTLY WHAT YOU ARE DOING [GO HERE INSTEAD](<https://github.com/OrcaSlicer/OrcaSlicer>)**.

> [!TIP]
> Share this guide to others!
>
> ```css
> https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/wiki/How-to-download-PR-artifacts
> ```
