...
1. Get PO-file 'OrcaSlicer_xx.pot' from corresponding sub-folder here:
   [https://github.com/NanashiTheNameless/OrcaSlicer/tree/master/localization/i18n](https://github.com/NanashiTheNameless/OrcaSlicer/tree/master/localization/i18n)
...
Notice. When the translation is complete you need to:
    ...
    - Bambu_Studio_fr.po needs to be copied into the sub-folder fr of [https://github.com/NanashiTheNameless/OrcaSlicer/tree/master/localization/i18n](https://github.com/NanashiTheNameless/OrcaSlicer/tree/master/localization/i18n), and be pushed
...
1. For convenience create a list of files with this macro `L(s)`. We have [localization/i18n/list.txt](https://github.com/NanashiTheNameless/OrcaSlicer/blob/main/localization/i18n/list.txt).
