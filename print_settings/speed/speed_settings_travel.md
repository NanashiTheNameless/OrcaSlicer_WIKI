...
[CLI Example](cli_mode#setting-overrides): `--travel-speed=1`.  
![travel-lines](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/speed/travel-lines.png?raw=true)
