...
[CLI Example](cli_mode#setting-overrides): `--layer-height=1` (same pattern for the other variables above).  
...
![layer-height-spheres](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Precision/layer-height-spheres.png?raw=true)
...
![layer-height](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Precision/layer-height.svg?raw=true)
