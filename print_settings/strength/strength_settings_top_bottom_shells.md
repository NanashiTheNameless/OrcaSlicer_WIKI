...
![top-bottom-shells](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/top-bottom-shells/top-bottom-shells.png?raw=true)
...
- Improved [concentric](strength_settings_patterns#concentric) top surface.
    - Before:![surface_expansion_concentric_before](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/top-bottom-shells/surface_expansion_concentric_before.png?raw=true)
    - After:![surface_expansion_concentric_after](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/top-bottom-shells/surface_expansion_concentric_after.png?raw=true)
