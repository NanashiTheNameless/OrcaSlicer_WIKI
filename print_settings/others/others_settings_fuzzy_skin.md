...
![Fuzzy-skin-Displacement-mode](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Fuzzy-skin/Fuzzy-skin-Displacement-mode.png?raw=true)
...
![Fuzzy-skin-Extrusion-mode](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Fuzzy-skin/Fuzzy-skin-Extrusion-mode.png?raw=true)
...
![Fuzzy-skin-Combined-mode](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Fuzzy-skin/Fuzzy-skin-Combined-mode.png?raw=true)
...
![Fuzzy-skin-classic](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Fuzzy-skin/Fuzzy-skin-classic.png?raw=true)
...
![Fuzzy-skin-perlin](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Fuzzy-skin/Fuzzy-skin-perlin.png?raw=true)
...
![Fuzzy-skin-billow](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Fuzzy-skin/Fuzzy-skin-billow.png?raw=true)

### Ridged Multifractal

Creates sharp, jagged features and high-contrast detail. Useful for stone- or marble-like textures.

![Fuzzy-skin-ridged-multifractal](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/Fuzzy-skin/Fuzzy-skin-ridged-multifractal.png?raw=true)
