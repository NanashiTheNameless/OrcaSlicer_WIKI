...
![mvf_measurement_point](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/MVF/mvf_measurement_point.jpg?raw=true)

Use calipers or a ruler to measure the **height** of the model just before the defects begin.  
![mvf_caliper_sample_mvf](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/MVF/mvf_caliper_sample_mvf.jpg?raw=true)
...
![mvf_gui_flow](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/MVF/mvf_gui_flow.png?raw=true)
...
![mvf_material_settings](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/MVF/mvf_material_settings.png?raw=true)
