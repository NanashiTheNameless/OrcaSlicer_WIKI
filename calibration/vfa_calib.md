...
1. Set the VFA test parameters in OrcaSlicer:  
   ![vfa_test_menu](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/vfa/vfa_test_menu.png?raw=true)
...
3. Print the VFA test:
   ![vfa_test_speed_check](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/vfa/vfa_test_speed_check.png?raw=true)
4. Inspect the tower for MRR artifacts. Look for speeds where the surface becomes visibly smoother or rougher. This allows you to pinpoint problematic speed ranges.  
   ...
   ![vfa_test_print](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/vfa/vfa_test_print.jpg?raw=true)
5. Configure the [Resonance Avoidance Speed Range](printer_motion_ability#resonance-avoidance) in the printer profile to skip speeds that cause visible artifacts.
   ![vfa_resonance_avoidance](https://github.com/NanashiTheNameless/OrcaSlicer_WIKI/blob/main/images/vfa/vfa_resonance_avoidance.png?raw=true)
